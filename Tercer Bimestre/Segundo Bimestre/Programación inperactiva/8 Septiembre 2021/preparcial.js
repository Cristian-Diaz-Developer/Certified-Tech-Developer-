...
/*******************************/
const inmobiliaria = {
                /* A Agregar una propiedad llamada departamentos que contenga los departamentos a partir del array que se encuentra en la plantilla.  Resultado esperado: Debe contener un array de objetos (todos los departamentos).*/
...
listarDepartamentos: function (arrayDepartamentos) {
  for (let i = 0; i < arrayDepartamentos.length; i++) {
    ...
    console.log('id: ' +    departamento.id + ' Precio: ' + departamento.precioAlquiler + (departamento.disponible ? " Disponible" : " Alquilado") + ' Cantidad de habitaciones: ' + departamento.cantidadHabitacion + ' Cantidad de personas: ' + departamento.cantidadPersonas + (departamento.aceptaMascotas ? ' Acepta mascotas' : ' No acepta mascotas') + ' Propietarios del departamento:  '+ departamento.propietarios );
    
  }
}

/* C  Agregar un método departamentosDisponibles que permita consultar disponibilidad, es decir, que devuelva una lista de los departamentos disponibles. Resultado esperado: un array con los departamentos disponibles únicamente*/
